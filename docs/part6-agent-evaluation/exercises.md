...
sentence. Run quick evaluation and inspect all three results.

## Exercise 2: Test tool misuse

Create adversarial prompts that attempt to:
...
Add them to the red-team input file, generate attacks, and run them. Do not put
real personal data in test prompts.

## Exercise 3: Turn a failure into a regression test

Choose one genuine failure:
...
Write a short note containing the failure, root cause, change, and result.
