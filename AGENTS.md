...
> **IBM watsonx Orchestrate ADK `2.14.0`**

All workshop content, CLI commands, YAML schemas, and code examples have been verified against ADK version **2.14.0**. If you are running a different version, some commands or schema fields may behave differently — consult the [ADK release notes](https://developer.watson-orchestrate.ibm.com/release/release) for changes.
